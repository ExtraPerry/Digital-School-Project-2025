                ...
                <div className="hidden md:flex items-center space-x-1">
                  ...
                  <Link href="/rental-history">
                    <Button
                      ...
                      size="sm"
                      className={isActivePath("/rental-history") 
                        ? "bg-blue-600 text-white hover:bg-blue-700" 
                        : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                      }
                      >
                  ...
                  <Link href="/partner-program">
                    <Button
                      variant={isActivePath("/partner-program") ? "default" : "ghost"}
                      size="sm"
                      className={isActivePath("/partner-program") 
                        ? "bg-blue-600 text-white hover:bg-blue-700" 
                        : "text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
                      }
                      >
                  ...
                  {isDropdownOpen && (
                    <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg border border-gray-200 dark:border-gray-700 z-50">
                      <div className="py-1">
                        ...
                        <Link href="/rental-history" onClick={handleDropdownItemClick}>
                          <div className={`block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer ${
                            isActivePath("/rental-history") 
                              ? "bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-400" 
                              : "text-gray-700 dark:text-gray-300"
                          }`}>
                            <div className="flex items-center">
                        ...
                        <Link href="/partner-program" onClick={handleDropdownItemClick}>
                          <div className={`block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer ${
                            isActivePath("/partner-program") 
                              ? "bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-400" 
                              : "text-gray-700 dark:text-gray-300"
                          }`}>
                            <div className="flex items-center">
                        ...
                        <Link href="/settings" onClick={handleDropdownItemClick}>
                          <div className={`block px-4 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer ${
